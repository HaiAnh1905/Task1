...
// const fruit = ['banana','apple','pineapple','orange','mango']
fruit.sort();
console.log(fruit); // trả về: [ 'apple', 'banana', 'mango', 'orange', 'pineapple' ]
// Sắp xếp các con số
const num = [2,30, 100, 9]
num.sort();
console.log(num);// trả về: [ 100, 2, 30, 9 ]
// giải thích: kết quả trả về là sai bởi vì hàm sort nghĩ là 100 < 2 như 1<2 nên mới sắp xếp 100 lên trước 2, 
// để tránh tính trạng như trên thì ta làm như sau
num.sort((firstEl, secondEl) => {
    let huh;
    // console.log(secondEl, firstEl);
    
    secondEl > firstEl ? huh = -1 : huh = 0;
    return huh;
})
console.log(num);// trả về: [2,9,30,100]
// giải thích: đoạn này em ko hiểu lắm @@

//==============================================

// every()
// hàm every() là 1 phương thức dành cho đối tượng cho js, công dụng của hàm này là để ktra tính toàn thể của 1 mảng, nếu có 1 phần tử trong mảng ko
// thõa mãn điều kiện thì sẽ trả về false, nếu thõa toàn bộ thì trả về true
// cú pháp: every(function)
// demo:
const evenNum = [2,4,6,10,13,14,18];
console.log(evenNum.every((item) => {
    return item % 2 == 0
